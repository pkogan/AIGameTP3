...
Behavior_Flee.prototype = Object.create(Behavior.prototype);//Degfino que es sub clase de Sprite.
Behavior_Flee.prototype.constructor = Behavior_Flee;
...
Behavior_Flee.prototype.seek=function(){
...
Behavior_Flee.prototype.calcularDesiredVelocity=function () {
    // Calculo el vector deseado = normalizado(POSICION TARGET - POSICION this.sprite) * maximaVelocidad

    var vectorDesired;
    vectorDesired = ((Phaser.Point.subtract(this.sprite.position, this.target.sprite.position)).normalize()).multiply(this.max_speed, this.max_speed);

    return vectorDesired;
}

Behavior_Flee.prototype.calcularSteeringForce=function(vectorDesired){
...
Behavior_Flee.prototype.aplicarVectorDeFuerza=function(vectorSteeringForce) {
